// Security Manager V2 - Vylepšená bezpečnost s Web Crypto API
...
class SecurityManager {
    constructor() {
        ...
        console.log('🔐 Security Manager V2 initializing...');
        this.initialize();
    }
    ...
    async initialize() {
        try {
            ...
            console.log('🔐 Security Manager V2 initialized');
        } catch (error) {
    ...
    async exportSecureData(password) {
        ...
        const salt = new Uint8Array(16); // Pro tento příklad používáme fixní salt
...
console.log('🔐 Security Manager V2 loaded');
